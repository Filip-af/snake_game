...
# Game Title
pygame.display.set_caption("No kurwa Snake a co innego?")
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("No i przegrałeś, przegrywie XDDD", white, 100, 250)
            ...
            gameWindow.fill(white)
            text_screen("Masz wynik i spierdalaj: " + str(score * 10), red, 5, 5)
